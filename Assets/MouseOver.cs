...
public class MouseOver : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        //if (gameObject.name == "PracticeTrigger") button.sprite = buttonNormalState;
